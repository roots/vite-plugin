...
describe("vite build integration", () => {
    ...
    describe("fonts", () => {
        it("should extract all default font families", async () => {
            ...
            expect(fonts).toContainEqual(expect.objectContaining({ slug: "sans" }));
            expect(fonts).toContainEqual(expect.objectContaining({ slug: "serif" }));
            expect(fonts).toContainEqual(expect.objectContaining({ slug: "mono" }));
        });
    ...
    describe("font sizes", () => {
        it("should extract all 13 font sizes", async () => {
            ...
            for (const size of expectedSizes) {
                expect(sizes).toContainEqual(expect.objectContaining({ slug: size }));
            }
        });
    ...
    describe("border radius", () => {
        it("should extract all 8 border radius sizes", async () => {
            ...
            for (const slug of expectedSlugs) {
                expect(radiusSizes).toContainEqual(expect.objectContaining({ slug }));
            }
        });
    ...
    describe("base theme.json with existing values", () => {
        ...
        it("should preserve base fontFamilies when fonts are disabled", async () => {
            ...
            expect(fonts).toContainEqual(expect.objectContaining({ slug: "brand" }));
        ...
        it("should preserve base fontSizes when font sizes are disabled", async () => {
            ...
            expect(sizes).toContainEqual(expect.objectContaining({ slug: "tiny", size: ".5rem" }));
            expect(sizes).toContainEqual(expect.objectContaining({ slug: "xl", size: "99rem" }));
        });
